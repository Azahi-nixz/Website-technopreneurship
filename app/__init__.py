        ...
        with get_connection() as conn:
            ...
            if products_file.exists():
                ...
                for p in products:
                    conn.run("""
                        ...
                        VALUES (:id, :name, :description, :price, :is_active, :created_at)
                    """, id=p["id"], name=p["name"], description=p.get("description"),
                        price=p["price"], is_active=p.get("is_active", True),
                    ...
                    for img in p.get("images", []):
                        ...
                        """, id=img["id"], product_id=img["product_id"],
                            image_url=img["image_url"], display_order=img["display_order"])
            ...
            if theme_file.exists():
                ...
                if themes:
                    t = themes[0]
                    conn.run("""
                        INSERT INTO site_theme (id, accent_color, background_color, font_family, updated_at)
                        VALUES (1, :accent_color, :background_color, :font_family, :updated_at)
                    ...
                    """, accent_color=t.get("accent_color", "#D4AF37"),
                        background_color=t.get("background_color", "#0A0E1A"),
                ...
                if contents:
                    ...
                    conn.run("""
                        INSERT INTO site_content (
                            ...
                            1, :site_title, :brand_name, :hero_headline, :hero_subheadline,
                            :nav_home_label, :nav_products_label, :nav_cart_label, :nav_orders_label,
                            :footer_tagline, :footer_copyright, :section_heading, :section_subheading,
                            :cta_shop_now, :cta_view_cart, :cta_sign_in,
                            :empty_cart_message, :empty_orders_message, :updated_at
                    ...
                    """, site_title=c.get("site_title"),
                        ...
                        hero_headline=c.get("hero_headline"),
                        hero_subheadline=c.get("hero_subheadline"),
                        nav_home_label=c.get("nav_home_label"),
                        nav_products_label=c.get("nav_products_label"),
                        nav_cart_label=c.get("nav_cart_label"),
                        nav_orders_label=c.get("nav_orders_label"),
                        footer_tagline=c.get("footer_tagline"),
                        footer_copyright=c.get("footer_copyright"),
                        section_heading=c.get("section_heading"),
                        section_subheading=c.get("section_subheading", c.get("section_subheadline")),
                        cta_shop_now=c.get("cta_shop_now"),
                        cta_view_cart=c.get("cta_view_cart"),
                        cta_sign_in=c.get("cta_sign_in"),
                        empty_cart_message=c.get("empty_cart_message"),
                        empty_orders_message=c.get("empty_orders_message"),
